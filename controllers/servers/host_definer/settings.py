...
CSI_PROVISIONER_NAME = 'santricity.block.csi.ibm.com'
ADDED_EVENT = 'ADDED'
...
MANAGE_NODE_LABEL = 'hostdefiner.santricity.block.csi.ibm.com/manage-node'
FORBID_DELETION_LABEL = 'hostdefiner.santricity.block.csi.ibm.com/do-not-delete-definition'
CONNECTIVITY_TYPE_LABEL = 'santricity.block.csi.ibm.com/connectivity-type'
